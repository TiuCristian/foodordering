                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-10">
                        <div class="tab-content no-padding" id="myTab2Content">
                            ...
                            @include('admin.settings.sections.general-setting')

                            @include('admin.settings.sections.logo-setting')

                            @include('admin.settings.sections.appearance-setting')

                            @include('admin.settings.sections.pusher-setting')

                            @include('admin.settings.sections.mail-setting')

                            @include('admin.settings.sections.seo-setting')
